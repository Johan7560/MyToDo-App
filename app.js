...
const filterOption = document.querySelector('.filteredChoice');
...
for (const option of document.querySelectorAll('.filteredChoice')) {
	option.addEventListener('click', function () {
		if (!this.classList.contains('selected')) {
			this.parentNode
				.querySelector('.filterOption.selected')
				.classList.remove('selected');
			this.classList.add('selected');
			this.closest('.filterOption').querySelector(
